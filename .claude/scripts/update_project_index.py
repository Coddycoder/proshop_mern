...
# Adapted for this fork's real layout (Шаг 0): Express backend, CRA frontend,
# the two Python MCP servers, and the RAG pipeline. Standalone runs always
# update unconditionally; the hook only fires on structural changes here.
WATCH_PATHS = ("backend/", "frontend/src/", "mcp-servers/", "rag/")
