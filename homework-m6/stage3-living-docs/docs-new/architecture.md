...
> **🔄 TODO(audit-2026-06-07):** Accurate C4 view of the original MERN stack (the proxy `:5001` label is correct — note `CLAUDE.md` still says `:5000`). Does **not** yet cover the M3–M5 additions (feature-flags MCP, search-docs MCP, RAG pipeline, n8n Auto-Pilot). The extended system overview that includes them lives at `docs/architecture/overview.md`.
